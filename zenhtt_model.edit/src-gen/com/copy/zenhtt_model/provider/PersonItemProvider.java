...
/**
 * This is the item provider adapter for a {@link com.copy.zenhtt_model.Person} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PersonItemProvider extends EntityItemProvider {
	/**
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Zenhtt_modelPackage.Literals.PERSON__NAME, true, false, false,
	...
	protected void addLandlordPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Person_landlord_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Person_landlord_feature",
								"_UI_Person_type"),
						Zenhtt_modelPackage.Literals.PERSON__LANDLORD, true, false, false,
	...
	protected void addTenantPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Person_tenant_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Person_tenant_feature", "_UI_Person_type"),
						Zenhtt_modelPackage.Literals.PERSON__TENANT, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
